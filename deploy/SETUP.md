...
| Domain | App | Traffic |
|---|---|---|
| billing.hargeiswatertech.com | `backend/web` | Billing clerks / admin (browser) |
| api.hargeiswatertech.com | `api/web` | ThingsBoard webhook + machine-to-machine |
...
```
billing.hargeiswatertech.com  A  52.21.182.214
api.hargeiswatertech.com      A  52.21.182.214
```

## 1. Install the Apache vhosts

```bash
sudo cp /home/admin/nobleus-admin/deploy/billing.hargeiswatertech.com.conf /etc/apache2/sites-available/
sudo cp /home/admin/nobleus-admin/deploy/api.hargeiswatertech.com.conf /etc/apache2/sites-available/
sudo a2ensite billing.hargeiswatertech.com api.hargeiswatertech.com
...
sudo certbot --apache -d billing.hargeiswatertech.com -d api.hargeiswatertech.com \
...
before disabling it, or point the mobile app at api.hargeiswatertech.com.

## 4. ThingsBoard Rule Engine (REST API Call node)

- URL: `https://api.hargeiswatertech.com/v1/telemetry-receive`
- Method: POST
