...
return [
    ...
    'Hello %name%, Your Dhaamiye Darawal password reset code is %code%' => 'Hello %name%, Your Dhaamiye Darawal password reset code is %code%',
    'Hello %name%, Your Dhaamiye Activation code is %code%' => 'Hello %name%, Your Dhaamiye Activation code is %code%',
    'Hello %name%, Your Dhaamiye order for %volume% from %vendor_name% has been rejected' => 'Hello %name%, Your Dhaamiye order for %volume% from %vendor_name% has been rejected',
    'Hello %name%, REF:HWA-%ref%, You have a %single_shared% Dhaamiye order of %volume% to %address%,  %date%. %order_details%' => 'Hello %name%, REF:HWA-%ref%, You have a %single_shared% Dhaamiye order of %volume% to %address%,  %date%. %order_details%',
    'Hello %name%, Your Dhaamiye order for %volume% from %vendor_name% has been accepted and ready for delivery on %date%' => 'Hello %name%, Your Dhaamiye order for %volume% from %vendor_name% has been accepted and ready for delivery on %date%',
    'Hello %name%, Your Dhaamiye order for %volume% from %vendor_name% has been delivered on %date%' => 'Hello %name%, Your Dhaamiye order for %volume% from %vendor_name% has been delivered on %date%',
    'Hello %name%, Your %single_shared% Dhaamiye order for %volume% from %vendor_name% on %date% has been created successfully' => 'Hello %name%, Your %single_shared% Dhaamiye order for %volume% from %vendor_name% on %date% has been created successfully',
    'Hello %name%, Your Dhaamiye order for %volume% from %vendor_name% on %date% has been rejected' => 'Hello %name%, Your Dhaamiye order for %volume% from %vendor_name% on %date% has been rejected',
    'Hello %name%, Your Dhaamiye vendor account has been created successfully. Your login credentials are as follows: Phone: %phone% and Password: %password%' => 'Hello %name%, Your Dhaamiye vendor account has been created successfully. Your login credentials are as follows: Phone: %phone% and Password: %password%',
    'Hello %name%, Your Dhaamiye vendor account has been reset. Your new login credentials are as follows: Phone: %phone% and Password: %password%' => 'Hello %name%, Your Dhaamiye vendor account has been reset. Your new login credentials are as follows: Phone: %phone% and Password: %password%',
    ...
    'Hello %name%, Your Dhaamiye order for %volume% from %vendor_name% on %date% has been declined. Kindly select another vendor from Dhaamiye app' => 'Hello %name%, Your Dhaamiye order for %volume% from %vendor_name% on %date% has been declined. Kindly select another vendor from Dhaamiye app',
